...
export const CATEGORIAS_NOTIFICACION = {
  ...
  CLUBES: { key: 'CLUBES', label: 'Clubes' },
...
export const TIPO_A_CATEGORIA = {
  ...
  SOLICITUD_CLUB: 'CLUBES',
  CLUB_ACEPTADA: 'CLUBES',
  CLUB_RECHAZADA: 'CLUBES',
  SOLICITUD_MEMBRESIA_CLUB: 'CLUBES',
  MEMBRESIA_CLUB_ACEPTADA: 'CLUBES',
  MEMBRESIA_CLUB_RECHAZADA: 'CLUBES',
  ANUNCIO_CLUB: 'CLUBES',
  INVITACION_CLUB_DIVISION: 'CLUBES',
  RESPUESTA_INVITACION_CLUB_DIVISION: 'CLUBES',
  CONVOCATORIA_ENTRENAMIENTO: 'CLUBES',
  ENTRENAMIENTO_FINALIZADO: 'CLUBES',
  COMENTARIO_AVISO: 'CLUBES',
  COMENTARIO_PUBLICACION: 'SOCIAL',
  REACCION_AVISO: 'CLUBES',
  REACCION_PUBLICACION: 'SOCIAL',
};
